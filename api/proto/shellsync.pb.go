...
type ServerUpdate struct {
	...
	//	*ServerUpdate_CloseTerminalRequest
...
func (x *ServerUpdate) GetCloseTerminalRequest() *CloseTerminalRequest {
	if x != nil {
		if x, ok := x.Payload.(*ServerUpdate_CloseTerminalRequest); ok {
			return x.CloseTerminalRequest
		}
	}
	return nil
}
...
type ServerUpdate_CloseTerminalRequest struct {
	CloseTerminalRequest *CloseTerminalRequest `protobuf:"bytes,5,opt,name=close_terminal_request,json=closeTerminalRequest,proto3,oneof"` // NEW: Add close terminal support
}
...
func (*ServerUpdate_CloseTerminalRequest) isServerUpdate_Payload() {}
...
// NEW: Add close terminal message
...
func (x *CloseTerminalRequest) Reset() {
	*x = CloseTerminalRequest{}
	mi := &file_api_proto_shellsync_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CloseTerminalRequest) Descriptor() ([]byte, []int) {
	return file_api_proto_shellsync_proto_rawDescGZIP(), []int{11}
}
...
const file_api_proto_shellsync_proto_rawDesc = "" +
	...
	"\x0fresize_terminal\x18\x04 \x01(\v2\x19.shellsync.TerminalResizeH\x00R\x0eresizeTerminal\x12W\n" +
	"\x16close_terminal_request\x18\x05 \x01(\v2\x1f.shellsync.CloseTerminalRequestH\x00R\x14closeTerminalRequestB\t\n" +
	"\apayload\"D\n" +
	...
	"\x06height\x18\x05 \x01(\rR\x06height\"7\n" +
...
var file_api_proto_shellsync_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_api_proto_shellsync_proto_goTypes = []any{
	...
	(*CloseTerminalRequest)(nil),    // 11: shellsync.CloseTerminalRequest
}
var file_api_proto_shellsync_proto_depIdxs = []int32{
	...
	11, // 7: shellsync.ServerUpdate.close_terminal_request:type_name -> shellsync.CloseTerminalRequest
	0,  // 8: shellsync.ShellSync.CreateSession:input_type -> shellsync.CreateRequest
	2,  // 9: shellsync.ShellSync.Stream:input_type -> shellsync.ClientUpdate
	1,  // 10: shellsync.ShellSync.CreateSession:output_type -> shellsync.CreateResponse
	7,  // 11: shellsync.ShellSync.Stream:output_type -> shellsync.ServerUpdate
...
func file_api_proto_shellsync_proto_init() {
	...
	file_api_proto_shellsync_proto_msgTypes[7].OneofWrappers = []any{
		...
		(*ServerUpdate_CloseTerminalRequest)(nil),
	}
	type x struct{}
