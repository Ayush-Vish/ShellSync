      ...
      ws.onmessage = (event) => {
        try {
          ...
          if (data.type === 'pong') {
            ...
            onMessage(data);
          } else if (data.type === 'terminal_resized') {
            // Handle terminal resize updates from other clients
            console.log('Terminal resized:', data.terminalId, data.width, data.height);
            onMessage(data);
          } else if (data.type === 'terminal_position_updated') {
            // Handle position updates from other clients
            console.log('Terminal position updated:', data.terminalId, data.x, data.y);
            onMessage(data);
          } else {
            onMessage(data);
          }
