...
export function HeroSection({ typedText }: { typedText: string }) {
  return (
    <div className="flex items-center justify-center antialiased pt-20">
        ...
        <LampDemo>
          <div className="md:w-1/2 mb-10 md:mb-0 flex flex-col items-center text-center">
            ...
            <p className="text-lg md:text-xl text-gray-300 mb-8">
              A secure web-based terminal that enables real-time collaboration over SSH. Code together, troubleshoot
              together, ship faster.
            </p>
          </div>
        </LampDemo>
        <SparklesPreview>
